	...
	if(key>head->Roll_No)
	{
		...
		void inorder(bstnode *head)
		{
			...
			if(head!=NULL)
			{
			    ...
			    cout<<setw(3)<<head->div;
			    cout<<setw(12)<<head->dob;
...
cout<<"Roll Number : ";
		...
		cin>>dob;
		cout<<"Enter Sudent's Telephone number";
		cin>>cell;
	...
	cin>>cell;
		...
		case 2:
			...
			case 3:
				...
				char cl;
				string bran;
				cout<<"Enter Roll Number,Divison,Branch of Student you want to search";
				cout<<"Roll Number";
				cin>>RNO;
				cout<<"Department";
				cin>>bran;
